        ...
        >
          ...
          <div className="relative h-10 w-10 cursor-pointer">
            ...
            >
              <Link
                to={'/shop'}
                className="flex flex-row gap-1 items-center px-4 py-2 font-medium tracking-wider text-sm text-black hover:bg-secondary-400/20"
              >
              ...
              <Link
                to={'/'}
                className="flex flex-row gap-1 items-center px-4 py-2 font-medium tracking-wider text-sm text-red-500 hover:bg-secondary-400/20"
